...
function ConnectionsPage() {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-white text-[28px] mb-2">My Connections</h1>
      <p className="text-[#A1A1A1] text-[15px] font-[Proza_Libre] mb-8">{connections.length} active connections</p>
